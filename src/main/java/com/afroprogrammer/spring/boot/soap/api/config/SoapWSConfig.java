package com.afroprogrammer.spring.boot.soap.api.config;
...
public class SoapWSConfig {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema schema){
        ...
        defaultWsdl11Definition.setTargetNamespace("http://www.afroprogrammer.com/spring/boot/soap/api/loanEligibility");
